...
class Booking {
  ...
  getData() {
    ...
    const startDateParam = settings.db.dateStartParamKey + '=' + utils.dateToStr(thisBooking.datePicer.minDate);
    const endDateParam = settings.db.dateEndParamKey + '=' + utils.dateToStr(thisBooking.datePicer.maxDate);
  ...
  parseData(bookings, eventsCurrent, eventsRepeat) {
    ...
    const minDate = thisBooking.datePicer.minDate;
    const maxDate = thisBooking.datePicer.maxDate;
  ...
  updateDOM() {
    ...
    thisBooking.date = thisBooking.datePicer.value;
